            ...
            <div className="row">
                ...
                <div className="card wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div className="form-header purple-gradient">
                        <h3 className="font-weight-500 my-2 py-1"><i className="fas fa-user"></i> Forgot Password</h3>
                    </div>


              <form onSubmit={this.props.status ? this.handleSubmit : this.handleVerify}>
...

                    {
                      ...
                      <div className="md-form pass">
                          ...
                          className="form-control"
                          />
                          <label htmlFor="orangeForm-pass">New password</label>
                      ...
                      <div className="md-form repass">
                        ...
                        />
                        <label htmlFor="orangeForm-repass">Re enter password</label>
                        { errors["repassword"] && <div className="alert alert-danger"> {errors["repassword"]} </div> }
                    </div>
                    <div className="md-form">
                  ...
                  <p style = {{paddingLeft: "38%"}}>Back to
